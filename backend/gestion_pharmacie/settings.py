...
# The deployed frontend's origin (e.g. https://pharmacie-six.vercel.app),
# not set locally since localhost is already covered above.
...
# Email Configuration
# Sent via Brevo's HTTPS API rather than SMTP - see api/email_backend.py
# for why (Render's free plan blocks outbound SMTP ports).
EMAIL_BACKEND = 'api.email_backend.BrevoAPIEmailBackend'
